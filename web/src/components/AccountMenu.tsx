      ...
      {open && (
        ...
        >
          <MenuItem
            ...
            label={copied ? 'Скопировано' : 'Копировать token_v2'}
          />
          <MenuItem onClick={onOpenProxy} icon={<IconExternalLink size={13} />} label="Открыть прокси" />
          ...
          <MenuItem
            ...
            label={confirming ? 'Подтвердить удаление?' : 'Удалить аккаунт'}
          />
        </div>
      )}
    </div>
